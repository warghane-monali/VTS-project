...
const AdminDashboard = ({getTabIndex, tabIndexData, adminDetails, getUpcomingPreviousRidesAdminData, getUserUpcomingRidesData, getUserPreviousRidesData, previousRides, upcomingRides, upcomingPreviousRides}) => {
